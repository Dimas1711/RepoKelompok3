...
import com.example.donasiyatim.detail.DetailDonasiActivity;
...
//        Toast.makeText(this, "data "+data.get("kunci"), Toast.LENGTH_SHORT).show();
        ...
        Intent notificationIntent = new Intent(getBaseContext(), DetailDonasiActivity.class);
        ...
        notificationBuilder.setAutoCancel(true)
                ...
                .setSmallIcon(R.drawable.donasi)
                .setTicker("Hearty365")
...
//        dispatcher.schedule(myJob);
    ...
    private void sendNotification(String body){
        Intent intent = new Intent(this, DetailDonasiActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingIntent = PendingIntent.getActivity(this,0,intent, PendingIntent.FLAG_ONE_SHOT);
        Uri defaultSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);

        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this);
        notificationBuilder.setSmallIcon(R.drawable.donasi);
