...
class Kasus_model extends CI_Model
{
	...
	{
		return $query = $this->db->query("SELECT kasus.id_kasus, kasus.gambar, panti.nama_panti, kategori.kategori, kasus.status FROM kasus,panti,kategori WHERE kasus.id_panti = panti.id_panti AND kasus.id_kategori = kategori.id_kategori")->result_array();
    }
}
?>