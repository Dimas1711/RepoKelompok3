...
<h1 class="h3 mb-2 text-gray-800">Daftar Panti</h1>
  ...
  <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="row">
              ...
              <button type="submit" href="<?= base_url('panti/tambahpanti') ?>" class="btn btn-info btn-icon-split">
                <span class="icon text-white-50">
                  <i class="fas fa-plus"></i>
                </span>
                <span class="text">Kirim Data</span>
              </button>
              <a href="<?= base_url('panti/index') ?>" class="btn btn-danger btn-icon-split">
                <span class="icon text-white-50">
