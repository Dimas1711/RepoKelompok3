                      ...
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">User</div>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="<?= base_url("admin/verif_kasus")?>">Selesai (<?php foreach($kasus2 as $row){?> <?=$row?> <?php }?>)</a>
                              <a class="dropdown-item" href="<?= site_url("admin/verif_topup")?>">Berjalan (<?php foreach($kasus1 as $row){?> <?=$row?> <?php }?>)</a>
                            </div>
                          </div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary" href="<?= site_url("admin/verif_topup")?>">Grafik Kasus</h6>
                  <!-- <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
                ...
                <div class="card-body" >
                  ...
                  <!-- <?php foreach($piechart as $row){?> <?=$row?> <?php }?> -->

                  <!-- <?php foreach($piechart as $row){
                     $grafik[] = (float) $row->is_active;} ?> -->
                   
                  <canvas id="myChart"  height="318"></canvas>
                      ...
                      var myChart = new Chart(ctx, {
                        ...
                        data: {
                          ...
                          datasets: [{
                            ...
                            //             echo "['" .$data->is_active . "'," . $data->is_active ."],\n";
                            //             }
                            //           }
                            //           ?>
                            //       ]
                            data: [<?php foreach($kasus1 as $row){?> <?=$row?> <?php }?>, <?php foreach($kasus2 as $row){?> <?=$row?> <?php }?>, <?php foreach($kasus3 as $row){?> <?=$row?> <?php }?>],
                            backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
                            'rgba(255, 206, 86, 0.2)',
